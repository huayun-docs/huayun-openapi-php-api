...
use ChinacApi\Core\Http\CResponse;
use ChinacApi\Core\Exception\ClientException;

class CHttp
{
    public static $connectTimeout = 300; //300 second
    public static $readTimeout = 300; //300 second
